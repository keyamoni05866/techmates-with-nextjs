    ...
    <Card className="w-full mb-8 px-4  py-3 shadow-md">
      ...
      <div className="flex justify-between mx-3  lg:mx-10 my-4">
        <div className="flex items-center">
          ...
          <p className="lg:text-xl text-lg font-semibold ms-1 mt-1">Vote</p>
        </div>
        <div className="flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="lg:text-xl text-lg font-semibold ms-1 ">Comment</p>
        </div>
        <div className="flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="lg:text-xl text-lg font-semibold ms-1 mt-1">Share</p>
        </div>
      </div>
    </Card>
  );
